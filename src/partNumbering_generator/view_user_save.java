...
public class view_user_save extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Data For Approval(User)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(view_user_save.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
